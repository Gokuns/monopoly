...
public class SquareFactory {
	...
	public Square createSquare(String name) {
		...
		if(name.equals("Roll Three")) {
			...
			result = new TransitStation(name,  "Passengers wishing to use the metrobus line should change at Sisli Mecidiyekoy or Gayrettepe stations.");
		}
			...
			result = new SqueezePlay(name,  "If your roll equal those numbers, collect the corresponding vale from each player");
		}
